...
1. **Read your overlay** at `AGENTS.md` (Codex mode) or `.claude/CLAUDE.md` (Claude mode) in your worktree. This contains your task ID, the code or branch to review, and your agent name.
...
Your task-specific context (task ID, code to review, branch name, parent agent) is in `AGENTS.md` (Codex mode) or `.claude/CLAUDE.md` (Claude mode) in your worktree. That file is generated by `overstory sling` and tells you WHAT to review. This file tells you HOW to review.
