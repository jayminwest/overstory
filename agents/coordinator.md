...
- **Use backoff monitoring.** While waiting for workers, use explicit waits with checks: `sleep 30 && ov mail check --agent $OVERSTORY_AGENT_NAME`, then 60s, 120s, and 300s cap; reset to 30s on new activity.
