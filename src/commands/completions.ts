		...
		subcommands: [
			{
				...
				flags: [
					...
					{ name: "--title", desc: "Title for Trellis spec output", takesValue: true },
					{ name: "--agent", desc: "Agent attribution", takesValue: true },
					{ name: "--seed", desc: "Linked Seeds issue ID", takesValue: true },
					{ name: "--reference", desc: "Reference path or URL", takesValue: true },
					{ name: "--constraint", desc: "Constraint line", takesValue: true },
					{ name: "--acceptance", desc: "Acceptance line", takesValue: true },
					{
						name: "--workflow",
						desc: "Workflow profile alias",
						takesValue: true,
					...
					{ name: "--trellis", desc: "Write to .trellis/specs/<task-id>.yaml" },
					{
						name: "--force",
						desc: "Replace an existing Trellis spec instead of refusing overwrite",
					},
					{ name: "--help", desc: "Show help" },
				],
			},
